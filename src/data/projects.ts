...
export const projects: Project[] = [
  ...
  },
  {
    slug: "tenga-thailand",
    name: "Tenga Thailand",
    typeLabel: "Next.js + WooCommerce",
    summary:
      "A redesigned storefront for the official Thai distributor of a Japanese wellness brand — rebuilt in Next.js with WooCommerce powering the product catalogue and orders.",
    featured: false,
    overview:
      "Tenga Thailand is the official Thai distributor for Tenga, a premium Japanese wellness brand. The site was redesigned and rebuilt from the ground up using Next.js for the frontend, with WooCommerce handling the product catalogue, inventory, and order management on the backend. The goal was a faster, more polished storefront that felt modern and trustworthy while keeping the familiar WooCommerce workflow the client already relied on.",
    client: "Tenga Thailand",
    scope: [
      "Full site redesign and rebuild in Next.js",
      "WooCommerce integration for product catalogue and order management",
      "Bilingual site structure (Thai and English)",
      "Product category pages and custom storefront components",
      "Shipping rules and same-day fulfillment logic",
      "Secure payment gateway integration",
      "Trust signal and brand authenticity messaging",
    ],
    highlights: [
      "Rebuilt in Next.js for significantly improved performance and page speed",
      "WooCommerce retained as the commerce backbone — familiar admin workflow preserved for the client",
      "Clean, modern design reduces stigma and positions products as legitimate wellness items",
      "Same-day shipping eligibility clearly surfaced to reduce cart abandonment",
    ],
